...
package com.maps.locationsecond;
 ...
 */
public class MainLocationActivity extends FragmentActivity implements
        LocationListener,
    ...
    public void getAddress(View v) {
        ...
        if (servicesConnected()) {
            ...
            (new MainLocationActivity.GetAddressTask(this)).execute(currentLocation);
        }
    }
